...
namespace AdminForm.PerformManagement
{
    public partial class GVMonitoring : Form
    {
        ...
        private void GvMonitoring_Load(object sender, EventArgs e)
        {
            ...
            CommonClass.AddNewColumnToDataGridView(dgvDry, "상태", "1", true, 100);
            CommonClass.AddNewColumnToDataGridView(dgvDry, "작업지시번호", "1", true, 100);
            ...
            CommonClass.AddNewColumnToDataGridView(dgvDry, "수량", "1", true, 100);
            ...
            CommonClass.AddNewColumnToDataGridView(dgvPlasticity, "상태", "1", true, 100);
            CommonClass.AddNewColumnToDataGridView(dgvPlasticity, "작업지시번호", "1", true, 100);
            ...
            CommonClass.AddNewColumnToDataGridView(dgvPlasticity, "수량", "1", true, 100);
