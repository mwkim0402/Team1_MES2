...
int colWidth = 100, DataGridViewContentAlignment textAlign = DataGridViewContentAlignment.MiddleLeft)
        ...
        private void Setdgv()
        {
            ...
            AddNewColumnToDataGridView(dataGridView1, "작업지시번호", "Title", true, 160);
            AddNewColumnToDataGridView(dataGridView1, "팔레트번호", "Title", true, 164);
            AddNewColumnToDataGridView(dataGridView1, "제품", "Title", true, 130);
            AddNewColumnToDataGridView(dataGridView1, "등급", "Title", true, 130);
            AddNewColumnToDataGridView(dataGridView1, "수량", "Title", true, 130);
